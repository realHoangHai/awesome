...
import (
	...
	"github.com/realHoangHai/awesome/internal/storage/ent/migrate"
...
var ProviderSet = wire.NewSet(NewEntClient, NewRedisCmd, NewStore, NewUserRepo, NewCardRepo, NewAddressRepo)
